...
class Tapestry(Furniture):
    ...
    def burn(self):
        print("La tapisserie s'embrase soudain, et en quelques minutes, il n'en reste rien. Elle devoile alors, encastre dans le mur, %s." %
              self.hidden_furniture.full_name)
